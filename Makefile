...
SRC		=	push_swap.c linked_list.c op_switch_elements_in_stack.c op_rotate_stack.c op_swap_stacks.c radix_sort.c edge_and_sorted.c new_numbers.c free.c input_checker.c lst_functions.c turk_sort.c find_op.c calculation.c
...
check: $(NAME)
	...
	#@valgrind --leak-check=full --show-leak-kinds=all ./$(NAME) $(INPUT5) | ./checker_Mac $(INPUT5)
	@printf " number of instructions... \t"
...
small_check: $(NAME)
	...
	#@valgrind --leak-check=full --show-leak-kinds=all ./$(NAME) $(INPUT7) | ./checker_Mac $(INPUT7)
	@printf " number of instructions... \t"
